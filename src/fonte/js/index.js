...
var mensagem = "Olá, caso tenha preferência por menos claridade, apertar no sol";
alert(" Olá, caso tenha preferência por menos claridade, apertar no sol")
...
botaoAlterarTema.addEventListener("click", () => {
  ...
  if (modoEscuroEstaAtivo) {
    imagemBotaoTrocaDeTema.setAttribute("src", "/src/fonte/img/sun.png");
  } else {
    imagemBotaoTrocaDeTema.setAttribute("src", "/src/fonte/img/moon.png");
  }
});
